...
switch solver_method
    ...
    case 'steepest_descent' 
        ...
        while (1)
            ...
            switch line_search
                case 'armijo'
                    % Use Armijo's rule
                    lambdak = armijo(data.objective, data.deri1, xk, d, data.lambda0, data.alpha, data.epsilon);
                case 'dich'
    ...
    case 'broyden'
        ...
        while (1)
            ...
            %update D:
            p=xk-x_prev;
            q=data.deri1(xk)-data.deri1(x_prev);
            v=p/(p'*q)-D*q/(q'*D*q);
